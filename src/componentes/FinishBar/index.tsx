  ...
  return (
   <div className="FinishBar">
     <div className="link">
       ...
       <a style={{ textDecoration: 'none', color: '#fff'}} target="_blank" href="https://github.com/cadu088">GitHub</a>
       </div>
       <div className="projetos" title="Meu Linkedin">
       <a style={{ textDecoration: 'none', color: '#fff'}} target="_blank" href="https://www.linkedin.com/in/carlos-eduardo-r-18b56718b/">Linkedin</a>
       </div>
